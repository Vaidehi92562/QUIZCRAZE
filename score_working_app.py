...
def multi_quiz_room():
    ...
    if not username:
        return "Invalid game session.", 400  # ✅ Prevent invalid session
    ...
    if not user:
        return "User not registered in this game.", 400
    ...
    return render_template("multi_quiz_room.html", game_code=game_code, username=username, questions=questions)
